...
SOYBEAN = dict(tt_maturity=2250, flowering_tt=1250, base_t=5, opt_t=28, max_t=43,
               ...
               make_layers=make_layers, calibration_factor=0.9644,  # re-derived 2026-09-23 for the
               # real-data TTF50_SHOOT_PARTITION refit (0.5 -> 0.32) + the same-day emergence-gate
               # fix -- see cycles_engine_validate.py
...
WHEAT = dict(tt_maturity=1800, flowering_tt=1250, base_t=0, opt_t=20, max_t=35,
             ...
             make_layers=make_layers, calibration_factor=0.6243,  # re-derived 2026-09-23 for the
             # real-data TTF50_SHOOT_PARTITION refit -- this fix is also the one that improved
             # wheat's own correlation (0.223 -> 0.276) -- plus the same-day emergence-gate fix,
             # see cycles_engine_validate.py
...
CORN_SILAGE = dict(tt_maturity=1800, flowering_tt=1000, base_t=6, opt_t=28, max_t=46,
                    ...
                    make_layers=make_layers, forage_fraction=0.95, calibration_factor=0.6736,  # re-derived
                    # 2026-09-23 for the real-data TTF50_SHOOT_PARTITION refit + the same-day
                    # emergence-gate fix -- see cycles_engine_validate.py
