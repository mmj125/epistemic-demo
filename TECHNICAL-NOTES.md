...
**Files:** `meteorology/energy-balance-sandbox.html` (`buildFineGrid`, `fineTileRange`, `computeTrendGrid` — the latter takes optional lat/lon/grid-source overrides so the same function serves both tiers).
